...
try:
    ...
    for group_entry in data:
        ...
        # Update all matching entries if the statuses are different, or if the old status is True
        for matching_entry in matching_entries:
            if matching_entry['is_active'] != is_active or matching_entry['is_active']:
