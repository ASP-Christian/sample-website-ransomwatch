...
date_elements = driver.find_elements("xpath", '//td[@class="date"]')
...
for i in range(len(company_names)):
    if company_names[i] not in existing_company_names:
        data_dict = {
            ...
            'ransomware_name': 'LockBIT Leaked',
            'ransomware_site': 'http://lockbit7z6f3gu6rjvrysn5gjbsqj3hk3bvsg64ns6pjldqr2xhvhsyd.onion/',
