...
date_elements = driver.find_elements("xpath", '//tr[@class="trow"]/td[5]')
...
for i in range(len(company_names)):
    if company_names[i] not in existing_company_names:
        data_dict = {
            ...
            'ransomware_name': 'Omega Blog',
            'ransomware_site': 'http://omegalock5zxwbhswbisc42o2q2i54vdulyvtqqbudqousisjgc7j7yd.onion/',
